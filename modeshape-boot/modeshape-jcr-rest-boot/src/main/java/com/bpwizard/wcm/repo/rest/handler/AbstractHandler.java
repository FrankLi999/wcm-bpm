...
import static com.bpwizard.wcm.repo.rest.RestHelper.BINARY_METHOD_NAME;
import static com.bpwizard.wcm.repo.rest.RestHelper.ITEMS_METHOD_NAME;
import static com.bpwizard.wcm.repo.rest.RestHelper.URL_ENCODER;
...
//        Session session = ModeshapeRequestContext.get();
//        if (session != null) {
//            try {
//            	ModeshapeRequestContext.logout();
...
//    }
    ...
    protected ResponseEntity<RestException> exceptionResponse(String message) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new RestException(message));
    }
}
