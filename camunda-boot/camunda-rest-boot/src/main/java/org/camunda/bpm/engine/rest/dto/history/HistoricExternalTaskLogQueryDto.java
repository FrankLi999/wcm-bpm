...
public class HistoricExternalTaskLogQueryDto extends AbstractQueryDto<HistoricExternalTaskLogQuery> {
	...
	public HistoricExternalTaskLogQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(HistoricExternalTaskLogQuery query, String sortBy, Map<String, Object> parameters,
