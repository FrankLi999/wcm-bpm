...
public interface JobDefinitionRestService {
	...
	public static final String PATH = "/camunda/api/engine/job-definition";
	 ...
	 * @return
	 */
	List<JobDefinitionDto> getJobDefinitions(HttpServletRequest request, Integer firstResult, Integer maxResults);

	List<JobDefinitionDto> queryJobDefinitions(
			JobDefinitionQueryDto queryDto,
			Integer firstResult, 
			Integer maxResults);

	CountResultDto getJobDefinitionsCount(HttpServletRequest request);
