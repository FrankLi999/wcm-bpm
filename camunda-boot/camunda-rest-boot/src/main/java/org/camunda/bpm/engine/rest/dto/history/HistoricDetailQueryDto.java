...
public class HistoricDetailQueryDto extends AbstractQueryDto<HistoricDetailQuery> {
	...
	public HistoricDetailQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
			...
			for (SortingDto sorting : sortings) {
				...
				if (!VALID_SORT_BY_VALUES.contains(sortingBy)) {
					throw new InvalidRequestException(HttpStatus.BAD_REQUEST,
							"sortBy parameter has invalid value: " + sortingBy);
				}
	...
	@Override
	protected void applySortBy(HistoricDetailQuery query, String sortBy, Map<String, Object> parameters,
