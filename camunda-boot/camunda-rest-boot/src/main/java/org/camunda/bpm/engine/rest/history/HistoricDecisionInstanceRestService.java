...
//	HistoricDecisionInstanceResource getHistoricDecisionInstance(@PathParam("id") String decisionInstanceId);
	 ...
	 * service.
	 */
	List<HistoricDecisionInstanceDto> getHistoricDecisionInstances(HttpServletRequest request,
			Integer firstResult, Integer maxResults);
	CountResultDto getHistoricDecisionInstancesCount(HttpServletRequest request);
