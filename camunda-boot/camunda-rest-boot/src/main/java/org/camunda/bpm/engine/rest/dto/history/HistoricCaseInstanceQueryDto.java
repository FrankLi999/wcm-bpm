...
public class HistoricCaseInstanceQueryDto extends AbstractQueryDto<HistoricCaseInstanceQuery> {
	...
	public HistoricCaseInstanceQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(HistoricCaseInstanceQuery query, String sortBy, Map<String, Object> parameters,
