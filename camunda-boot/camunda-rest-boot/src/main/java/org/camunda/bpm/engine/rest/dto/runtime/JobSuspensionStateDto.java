...
public class JobSuspensionStateDto extends SuspensionStateDto {
	...
	public void updateSuspensionState(ProcessEngine engine) {
		int params = (jobId != null ? 1 : 0) + (jobDefinitionId != null ? 1 : 0) + (processInstanceId != null ? 1 : 0)
				+ (processDefinitionId != null ? 1 : 0) + (processDefinitionKey != null ? 1 : 0);
	...
	protected UpdateJobSuspensionStateBuilder createUpdateSuspensionStateBuilder(ProcessEngine engine) {
		...
		if (jobId != null) {
			...
			UpdateJobSuspensionStateTenantBuilder tenantBuilder = selectBuilder
