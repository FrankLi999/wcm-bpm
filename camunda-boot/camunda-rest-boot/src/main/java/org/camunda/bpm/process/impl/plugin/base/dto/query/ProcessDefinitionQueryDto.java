 ...
 */
package org.camunda.bpm.process.impl.plugin.base.dto.query;
...
import org.camunda.bpm.process.rest.dto.AbstractRestQueryParametersDto;
...
public class ProcessDefinitionQueryDto extends AbstractRestQueryParametersDto<ProcessDefinitionDto> {
	...
	public ProcessDefinitionQueryDto(Map<String, String[]> queryParameters) {
