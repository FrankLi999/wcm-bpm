...
public class ActivityInstanceDto {
	...
	/**
	 * The id of the parent activity instance. If the activity is the process
	 * definition, {@link #getId()} and {@link #getParentActivityInstanceId()}
	...
	/**
	 * Returns the child activity instances. Returns an empty list if there are no
	 * child instances.
	 */
