...
/**
 * Defines common query operations, such as sorting options and validation. Also
 * allows to access its setter methods based on {@link CamundaQueryParam}
 * annotations which is used for processing Http query parameters.
 *
...
public abstract class AbstractQueryDto<T extends Query<?, ?>> extends AbstractSearchQueryDto {
	...
	public AbstractQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
