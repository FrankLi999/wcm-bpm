...
@RestController
@RequestMapping(TaskRestService.PATH + "{taskId}/localVariables")
public class LocalTaskVariablesRestController extends AbstractVariablesService {
	public final static String PATH = "/camunda/api/engine/task/{taskId}/localVariables";
	@Autowired 
