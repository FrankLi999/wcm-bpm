package com.bpwizard.bpm.invoice;
...
public class InvoiceTestCase extends ProcessEngineTestCase {
  ...
  public void testHappyPathV1() {
    InputStream invoiceInputStream = InvoiceTestCase.class.getClassLoader().getResourceAsStream("files/invoice.pdf");
  ...
  public void testHappyPathV2() {
    InputStream invoiceInputStream = InvoiceTestCase.class.getClassLoader().getResourceAsStream("invoice.pdf");
    VariableMap variables = Variables.createVariables()
      .putValue("creditor", "Great Pizza for Everyone Inc.")
      .putValue("amount", 300.0d)
      .putValue("invoiceCategory", "Travel Expenses")
