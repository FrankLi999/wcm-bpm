...
public class WcmRestController {
	...
	private void addColumn(Node rowNode, FormColumn column, String columnNameName) throws RepositoryException {
		...
		for (FormControl control : column.getFormControls()) {
			this.addControl(columnNode, control);
		}
	}
	
	private void addControl(Node columnNode, FormControl control) throws RepositoryException {
		Node controlNode = columnNode.addNode(control.getName(), "bpw:formControl");
