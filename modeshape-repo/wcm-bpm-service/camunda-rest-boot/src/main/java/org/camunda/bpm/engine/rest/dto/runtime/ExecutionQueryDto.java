...
public class ExecutionQueryDto extends AbstractQueryDto<ExecutionQuery> {
	...
	public ExecutionQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(ExecutionQuery query, String sortBy, Map<String, Object> parameters,
