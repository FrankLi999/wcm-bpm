...
public class FetchExternalTasksExtendedDto extends FetchExternalTasksDto {
	...
	public String toString() {
		return "FetchExternalTasksExtendedDto [asyncResponseTimeout=" + asyncResponseTimeout + ", maxTasks=" + maxTasks
				+ ", workerId=" + workerId + ", usePriority=" + usePriority + ", topics=" + topics + "]";
	}
