...
//	HistoricCaseActivityInstanceResource getHistoricCaseInstance(@PathParam("id") String caseActivityInstanceId);
	...
	/**
	 * Exposes the {@link HistoricCaseActivityInstanceQuery} interface as a REST
	 * service.
	 */
	List<HistoricCaseActivityInstanceDto> getHistoricCaseActivityInstances(HttpServletRequest request,
			Integer firstResult, Integer maxResults);
	CountResultDto getHistoricCaseActivityInstancesCount(HttpServletRequest request);
}
