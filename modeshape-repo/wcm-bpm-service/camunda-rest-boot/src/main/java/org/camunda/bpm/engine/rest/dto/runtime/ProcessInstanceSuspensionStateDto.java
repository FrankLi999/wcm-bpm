...
public class ProcessInstanceSuspensionStateDto extends SuspensionStateDto {
	...
	public Batch updateSuspensionStateAsync(ProcessEngine engine) {
		...
		UpdateProcessInstancesSuspensionStateBuilder updateSuspensionStateBuilder = createUpdateSuspensionStateGroupBuilder(
				engine);
		if (getSuspended()) {
	...
	protected UpdateProcessInstanceSuspensionStateBuilder createUpdateSuspensionStateBuilder(ProcessEngine engine) {
		UpdateProcessInstanceSuspensionStateSelectBuilder selectBuilder = engine.getRuntimeService()
		...
		if (processInstanceId != null) {
			...
			UpdateProcessInstanceSuspensionStateTenantBuilder tenantBuilder = selectBuilder
	...
	protected UpdateProcessInstancesSuspensionStateBuilder createUpdateSuspensionStateGroupBuilder(
		...
		if (historicProcessInstanceQuery != null) {
			if (groupBuilder == null) {
				groupBuilder = selectBuilder
						.byHistoricProcessInstanceQuery(historicProcessInstanceQuery.toQuery(engine));
			} else {
