...
public class UserOperationLogQueryDto extends AbstractQueryDto<UserOperationLogQuery> {
	...
	public UserOperationLogQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(UserOperationLogQuery query, String sortBy, Map<String, Object> parameters,
