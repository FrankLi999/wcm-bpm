...
/**
 * <p>
 * Dto for {@link AuthorizationException}
 * </p>
 *
 * <p>
...
public class AuthorizationExceptionDto extends ExceptionDto {
	...
	// getter / setters ////////////////////////
	/**
	 * @return the name of the resource if there is only one
	 *         {@link MissingAuthorizationDto}, {@code null} otherwise
	 *
	 * @deprecated Use {@link #getMissingAuthorizations()} to get the name of the
	 *             resource of the {@link MissingAuthorizationDto}(s). This method
	...
	/**
	 * @deprecated Use {@link #setMissingAuthorizations(List)}} to set the the
	 *             {@link MissingAuthorizationDto}(s). This method will be removed
	 *             in future version.
	 */
	@Deprecated
	...
	/**
	 * @return the id of the resource if there is only one
	 *         {@link MissingAuthorizationDto}, {@code null} otherwise
	 *
	 * @deprecated Use {@link #getMissingAuthorizations()} to get the id of the
	 *             resource of the {@link MissingAuthorizationDto}(s). This method
	 *             will be removed in future version.
	 */
	@Deprecated
	...
	/**
	 * @return the name of the violated permission if there is only one
	 *         {@link MissingAuthorizationDto}, {@code null} otherwise
	 *
	 * @deprecated Use {@link #getMissingAuthorizations()} to get the name of the
	 *             violated permission of the {@link MissingAuthorizationDto}(s).
	...
	/**
	 * @return Disjunctive list of {@link MissingAuthorizationDto} from which a user
	 *         needs to have at least one for the authorization to pass
	 */
