...
public interface HistoricIncidentRestService {
	 ...
	 * @return
	 */
	List<HistoricIncidentDto> getHistoricIncidents(HttpServletRequest request, Integer firstResult, Integer maxResults);
	CountResultDto getHistoricIncidentsCount(HttpServletRequest request);
}
