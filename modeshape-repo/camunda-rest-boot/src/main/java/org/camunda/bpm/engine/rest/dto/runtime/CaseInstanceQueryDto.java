...
public class CaseInstanceQueryDto extends AbstractQueryDto<CaseInstanceQuery> {
	...
	public CaseInstanceQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(CaseInstanceQuery query, String sortBy, Map<String, Object> parameters,
