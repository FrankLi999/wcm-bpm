...
public class SchemaLogQueryDto extends AbstractQueryDto<SchemaLogQuery> {
	...
	public SchemaLogQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(SchemaLogQuery query, String sortBy, Map<String, Object> parameters,
