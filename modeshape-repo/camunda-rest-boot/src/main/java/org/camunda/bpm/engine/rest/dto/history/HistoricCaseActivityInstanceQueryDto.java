...
public class HistoricCaseActivityInstanceQueryDto extends AbstractQueryDto<HistoricCaseActivityInstanceQuery> {
	...
	public HistoricCaseActivityInstanceQueryDto(ObjectMapper objectMapper,
	...
	protected void applySortBy(HistoricCaseActivityInstanceQuery query, String sortBy, Map<String, Object> parameters,
