...
public class ProcessDefinitionQueryDto extends AbstractQueryDto<ProcessDefinitionQuery> {
	...
	public ProcessDefinitionQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(ProcessDefinitionQuery query, String sortBy, Map<String, Object> parameters,
