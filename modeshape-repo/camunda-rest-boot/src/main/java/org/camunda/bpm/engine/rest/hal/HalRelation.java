...
public class HalRelation {
	...
	protected UriComponentsBuilder uriTemplate;
	 ...
	 * @return the relation
	 */
	public static HalRelation build(String relName, Class<?> resourceType, UriComponentsBuilder urlTemplate) {
	...
	public UriComponentsBuilder getUriTemplate() {
		return uriTemplate;
	}
