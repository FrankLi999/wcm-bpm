...
public class DeploymentQueryDto extends AbstractQueryDto<DeploymentQuery> {
	...
	public DeploymentQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	protected void applyFilters(DeploymentQuery query) {
		if (withoutSource != null && withoutSource && source != null) {
			throw new InvalidRequestException(HttpStatus.BAD_REQUEST,
					"The query parameters \"withoutSource\" and \"source\" cannot be used in combination.");
		}
	...
	@Override
	protected void applySortBy(DeploymentQuery query, String sortBy, Map<String, Object> parameters,
