...
public interface HistoricTaskInstanceReportService {
	 ...
	 */
	List<HistoricTaskInstanceReportResultDto> getTaskReportResults(HttpServletRequest request);

	/**
	 * creates a historic task instance duration report.
	 */
	List<ReportResultDto> getTaskDurationReportResults(HttpServletRequest request);
}
