...
public class MigratingTransitionInstanceValidationReportDto {
	...
	public static List<MigratingTransitionInstanceValidationReportDto> from(
			List<MigratingTransitionInstanceValidationReport> reports) {
	...
	public static MigratingTransitionInstanceValidationReportDto from(
			MigratingTransitionInstanceValidationReport report) {
