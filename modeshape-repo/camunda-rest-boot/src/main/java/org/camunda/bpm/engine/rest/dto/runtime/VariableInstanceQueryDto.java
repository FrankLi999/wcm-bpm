...
public class VariableInstanceQueryDto extends AbstractQueryDto<VariableInstanceQuery> {
	...
	public VariableInstanceQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(VariableInstanceQuery query, String sortBy, Map<String, Object> parameters,
