...
//	HistoricActivityInstanceResource getHistoricCaseInstance(@PathParam("id") String activityInstanceId);
	 ...
	 * @return
	 */
	List<HistoricActivityInstanceDto> getHistoricActivityInstances(HttpServletRequest request,
	 ...
	 * @return
	 */
	List<HistoricActivityInstanceDto> queryHistoricActivityInstances(
			HistoricActivityInstanceQueryDto query,
			Integer firstResult, Integer maxResults);

	CountResultDto getHistoricActivityInstancesCount(HttpServletRequest request);
