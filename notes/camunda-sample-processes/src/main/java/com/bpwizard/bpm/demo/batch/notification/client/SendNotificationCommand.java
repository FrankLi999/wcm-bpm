package com.bpwizard.bpm.demo.batch.notification.client;

import com.bpwizard.bpm.demo.batch.notification.handler.NotificationJobHandlerConfiguration;
...
public class SendNotificationCommand implements Command<String> {
	...
	public SendNotificationCommand(final ObjectMapper mapper, final String recipient, final String subject,
			final String body) {
