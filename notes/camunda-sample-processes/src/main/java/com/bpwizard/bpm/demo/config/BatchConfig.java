...
import com.bpwizard.bpm.demo.batch.assignment.MyAssignmentHandler;
import com.bpwizard.bpm.demo.batch.handler.PrintStringBatchJobHandler;
import com.bpwizard.bpm.demo.batch.notification.client.NotificationService;
...
//	public void send() {
//		notificationService.sendNotificationInaAJob("demo@example.com", "Miss Piggy is lost!", "Find her");
//	}
//	
//	@EventListener
