...
export const Examples: any = {
  ...
  asf: {
    ...
    schemas: [
      ...
      {
        name: "Hack: Conditional Required",
        file: "asf-hack-conditional-required",
      },
    ],
  },
  rjsf: {
  ...
  jsf: {
    ...
    schemas: [
      {
        name: "Single Field",
        file: "jsf-single-field",
        urlParameters: "?example=single-field",
      },
      {
        name: "Single Field With Layout",
        file: "jsf-single-field-with-layout",
        urlParameters: "?example=single-field-with-layout",
      },
      {
        name: "String Array With Layout",
        file: "jsf-string-array-with-layout",
        urlParameters: "?example=string-array-with-layout",
      },
      ...
      {
        name:
          "Fields - Arrays with tabs: the tabarray type w/ default & legend",
      ...
      {
        name: "Using event handlers and validators",
        file: "jsf-events-validators",
      ...
      {
        name:
          "Using previously submitted values - Multidimensional arrays with layout",
        file: "jsf-previousvalues-multidimensional-with-layout",
        urlParameters: "?example=previousvalues-multidimensional-with-layout",
      },
    ],
  },
};
