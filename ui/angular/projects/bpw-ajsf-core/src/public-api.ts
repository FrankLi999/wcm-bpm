...
} from "./lib/json-schema-form.service";
...
export { WidgetLibraryService } from "./lib/widget-library.service";
export {
...
export * from "./lib/shared-widget/shared-widget";
export * from "./lib/shared-widget/shared-widget.module";
