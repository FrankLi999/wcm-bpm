...
export const appRouteReducers: ActionReducerMap<AppRouteState> = {
  routeState: routerReducer,
};

///site-explorer/bpw/default?a=b#top
...
export const getRouteState = createFeatureSelector<
  RouterReducerState<RouteSnapshot>
>("routeState");
// export const getRouteState = state => state.routeState;
export const getRouteSnapshot = createSelector(
  getRouteState,
  (routeState) => routeState.state
);

export class RouteSnapshotSerializer
  implements RouterStateSerializer<RouteSnapshot> {
