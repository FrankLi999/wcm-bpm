...
@Component({
  selector: "render-template-permissions",
  templateUrl: "./render-template-permissions.component.html",
  styleUrls: ["./render-template-permissions.component.scss"],
  encapsulation: ViewEncapsulation.None,
  animations: wcmAnimations,
})
export class RenderTemplatePermissionsComponent implements OnInit, OnDestroy {
