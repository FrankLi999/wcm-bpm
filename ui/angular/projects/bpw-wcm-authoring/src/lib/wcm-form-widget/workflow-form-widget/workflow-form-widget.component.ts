...
@Component({
  selector: "bpw-wcm-authoring-workflow-form-widget",
  templateUrl: "./workflow-form-widget.component.html",
  styleUrls: ["./workflow-form-widget.component.scss"],
  encapsulation: ViewEncapsulation.None,
  animations: wcmAnimations,
})
export class WorkflowFormWidgetComponent implements OnInit, OnDestroy {
  ...
  onNodeSelected(node: WcmNode) {
    if (node.nodeType === "bpw:system_bpmnWorkflowType") {
