...
@Component({
  selector: "content-area-layout-form-widget",
  templateUrl: "./content-area-layout-form-widget.component.html",
  styleUrls: ["./content-area-layout-form-widget.component.scss"],
  encapsulation: ViewEncapsulation.None,
  animations: wcmAnimations,
})
export class ContentAreaLayoutFormWidgetComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.nodeFilter = {
      wcmPath: "",
      nodeTypes: ["bpw:contentAreaLayout"],
    };
  ...
  onNodeSelected(node: WcmNode) {
    if (node.nodeType === "bpw:contentAreaLayout") {
