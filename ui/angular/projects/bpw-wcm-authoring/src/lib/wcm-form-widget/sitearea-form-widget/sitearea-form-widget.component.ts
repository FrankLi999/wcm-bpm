...
@Component({
  selector: "sitearea-form-widget",
  templateUrl: "./sitearea-form-widget.component.html",
  styleUrls: ["./sitearea-form-widget.component.scss"],
  encapsulation: ViewEncapsulation.None,
  animations: wcmAnimations,
})
export class SiteareaFormWidgetComponent implements OnInit, OnDestroy {
  ...
  onNodeSelected(node: WcmNode) {
    if (node.nodeType === "bpw:system_siteAreaType") {
