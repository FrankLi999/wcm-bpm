...
@Component({
  selector: "validation-rule-history",
  templateUrl: "./validation-rule-history.component.html",
  styleUrls: ["./validation-rule-history.component.scss"],
  encapsulation: ViewEncapsulation.None,
  animations: wcmAnimations,
})
export class ValidationRuleHistoryComponent implements OnInit, OnDestroy {
