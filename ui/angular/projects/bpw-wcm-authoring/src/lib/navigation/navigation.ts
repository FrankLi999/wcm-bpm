...
export const navigation: Navigation[] = [
  {
    ...
    title: "WCM Authoring",
    type: "group",
    translate: "NAV.WCM_AUTHORING.TITLE",
    icon: "lock",
    children: [
      {
        id: "site-explorer",
      ...
      },
      {
        id: "review-tasks",
        title: "Review Tasks",
        translate: "NAV.REVIEW_TASKS.TITLE",
        type: "item",
        icon: "archive",
        url: "/wcm-authoring/review-tasks",
      },
      {
        id: "jcr-explorer",
        title: "JCR Explorer",
      ...
      },
      {
        id: "site-config",
        title: "Site Config",
        translate: "NAV.SITE_CONFIG.TITLE",
        type: "item",
        icon: "archive",
        url: "/wcm-authoring/site-config/list",
      },
      {
      ...
      },
      {
        id: "form-designer",
        title: "Form Designer",
        translate: "NAV.FORM_DESIGNER.TITLE",
        type: "item",
        icon: "settings",
        url: "/wcm-authoring/form-designer/list",
      },
      {
        id: "authoring-template",
        title: "Authoring Template",
        translate: "NAV.AUTHORING_TEMPLATE.TITLE",
        type: "item",
        icon: "settings",
        url: "/wcm-authoring/authoring-template/list",
      },
      {
        id: "render-template",
