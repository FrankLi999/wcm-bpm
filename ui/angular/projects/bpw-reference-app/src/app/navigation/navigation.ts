                ...
                children: [
                    {
                        ...
                        title: 'Server',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/server'
                    },
                    {
                        id   : 'production',
                        title: 'Production',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/production'
                    },
                    {
                        id   : 'directory-structure',
                        title: 'Directory Structure',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/directory-structure'
                    },
                    {
                        id   : 'updating-wcm',
                        title: 'Updating WCM',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/updating-wcm'
                    },
                    {
                        id   : 'multi-language',
                        title: 'Multi Language',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/multi-language'
                    },
                    {
                        id   : 'material-theming',
                        title: 'Material Theming',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/material-theming'
                    },
                    {
                        id   : 'theme-layouts',
                        title: 'Theme Layouts',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/theme-layouts'
                    },
                    {
                        id   : 'page-layouts',
                        title: 'Page Layouts',
                        type : 'item',
                        url  : '/documentation/working-with-wcm/page-layouts'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'ifOnDom',
                        type : 'item',
                        url  : '/documentation/directives/if-on-dom'
                    },
                    {
                        id   : 'inner-scroll',
                        title: 'innerScroll',
                        type : 'item',
                        url  : '/documentation/directives/inner-scroll'
                    },
                    {
                        id   : 'mat-sidenav',
                        title: 'matSidenav',
                        type : 'item',
                        url  : '/documentation/directives/mat-sidenav'
                    },
                    {
                        id   : 'perfect-scrollbar',
                        title: 'perfectScrollbar',
                        type : 'item',
                        url  : '/documentation/directives/perfect-scrollbar'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'UI Config',
                        type : 'item',
                        url  : '/documentation/services/ui-config'
                    },
                    {
                        id   : 'splash-screen',
                        title: 'Splash Screen',
