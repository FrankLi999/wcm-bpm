import { IBpmnPalette, IBpmnPaletteProvider } from "./bpmn-js";

export class CustomBpmnPaletteProvider implements IBpmnPaletteProvider {
  ...
  constructor(
    private palette: IBpmnPalette,
    private originalPaletteProvider: IBpmnPaletteProvider,
    elementFactory
  ) {
    ...
    return {
      save: {
        ...
        action: {
          click: () =>
            console.log(
              "TEST Action clicked! Elementfactory: ",
              this.elementFactory
            ),
        },
      },
