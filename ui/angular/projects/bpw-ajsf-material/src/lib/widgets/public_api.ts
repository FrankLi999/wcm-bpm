...
import { MaterialAceEditorComponent } from "./material-ace-editor.component";
export const MATERIAL_FRAMEWORK_COMPONENTS = [
  ...
  MaterialAceEditorComponent,
];

// export { FlexLayoutRootComponent } from "./flex-layout-root.component";
export { MaterialAceEditorComponent } from "./material-ace-editor.component";
