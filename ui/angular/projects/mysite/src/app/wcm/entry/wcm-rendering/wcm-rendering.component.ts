...
import { mysiteLayoutConfig } from "../../../config/mysite.config";
import { navigation } from "../../../navigation/navigation";
import { locale as navigationEnglish } from "../../../navigation/i18n/en";
import { locale as navigationTurkish } from "../../../navigation/i18n/tr";

@Component({
  selector: "wcm-rendering",
  templateUrl: "./wcm-rendering.component.html",
  styleUrls: ["./wcm-rendering.component.scss"],
})
export class WcmRenderingComponent implements OnInit {
  constructor(
