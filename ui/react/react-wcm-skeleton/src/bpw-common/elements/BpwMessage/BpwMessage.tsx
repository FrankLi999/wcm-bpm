...
function BpwMessage(props) {
  const dispatch = useDispatch();
  const state = useSelector(({ bpw }) => bpw.message.state);
  const options = useSelector(({ bpw }) => bpw.message.options);
...
export default React.memo(BpwMessage);
