...
function BpwChipSelect(props) {
  ...
  return props.variant === 'fixed' ? (
    <Select classNamePrefix="bpw-chip-select" {...props} components={components} onChange={handleOnChange} />
  ) : (
    <Creatable classNamePrefix="bpw-chip-select" {...props} components={components} onChange={handleOnChange} />
  );
}

export default React.memo(BpwChipSelect);
