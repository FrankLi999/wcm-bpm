...
function SchemePreview({ theme, className, id, onSelect }) {
  ...
  return (
    <div className={clsx(className, 'mb-8')}>
      <button
        className={clsx('w-full text-left rounded-6 relative font-500 shadow-1 hover:shadow-2 cursor-pointer overflow-hidden')}
        style={{
          backgroundColor,
...
function BpwThemeSchemes(props) {
...
export default React.memo(BpwThemeSchemes);
