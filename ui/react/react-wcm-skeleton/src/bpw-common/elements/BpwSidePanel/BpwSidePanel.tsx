...
function BpwSidePanel(props) {
  ...
  return (
    <>
      <Hidden mdDown>
        <Paper className={clsx(classes.root, classes.paper, props.className, opened ? 'opened' : 'closed', props.position)} elevation={3} square>
          <BpwScrollbars className={clsx('content', classes.content)}>{props.children}</BpwScrollbars>
...
BpwSidePanel.propTypes = {};
BpwSidePanel.defaultProps = {
  position: 'left',
  opened: true,
};

export default React.memo(BpwSidePanel);
