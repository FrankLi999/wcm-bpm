...
const BpwScrollbars = React.forwardRef((props, ref) => {
  ref = ref || createRef();
...
function mapStateToProps({ bpw }) {
  return {
    customScrollbars: bpw.settings.current.customScrollbars,
  };
}

BpwScrollbars.propTypes = {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(withRouterAndRef(BpwScrollbars));
