...
import BpwPageSimpleHeader from './BpwPageSimpleHeader';
import BpwPageSimpleSidebar from './BpwPageSimpleSidebar';
...
const BpwPageSimple = React.forwardRef((props, ref) => {
  // console.info("render::BpwPageSimple");
  ...
  return (
    <div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
      ...
      <div className="flex flex-auto flex-col container z-10 h-full">
        {props.header && props.sidebarInner && <BpwPageSimpleHeader header={props.header} classes={classes} />}

        <div className={classes.wrapper}>
          {(props.leftSidebarHeader || props.leftSidebarContent) && (
            <BpwPageSimpleSidebar
              position="left"
          ...
          {/* > */}
          <BpwScrollbars className={classes.contentWrapper} enable={props.innerScroll && !props.sidebarInner}>
            {props.header && !props.sidebarInner && <BpwPageSimpleHeader header={props.header} classes={classes} />}
...
BpwPageSimple.defaultProps = {};

export default React.memo(BpwPageSimple);
