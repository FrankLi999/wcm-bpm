...
function NavbarMobileToggleFab(props) {
  ...
  return (
    <Tooltip title="Show Navigation" placement={layout.navbar.position === 'left' ? 'right' : 'left'}>
      <Fab className={clsx(classes.mobileButton, layout.navbar.position, props.className)} onClick={(ev) => dispatch(navbarToggleMobile())} disableRipple>
