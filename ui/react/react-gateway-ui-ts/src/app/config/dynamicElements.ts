...
const dynamicElements = {
  ...
  FirewallSelectors: FirewallSelectors,
  FirewallSelectorRules: FirewallSelectorRules,
  SpringCloudSelectors: SpringCloudSelectors,
  SpringCloudSelectorRules: SpringCloudSelectorRules,
  SignSelectors: SignSelectors,
  SignSelectorRules: SignSelectorRules,
  MonitorSelectors: MonitorSelectors,
  MonitorSelectorRules: MonitorSelectorRules,
  DivideSelectors: DivideSelectors,
  DivideSelectorRules: DivideSelectorRules,
  HystrixSelectors: HystrixSelectors,
  HystrixSelectorRules: HystrixSelectorRules,
  RateLimiterSelectors: RateLimiterSelectors,
  RateLimiterSelectorRules: RateLimiterSelectorRules,
  RewriteSelectors: RewriteSelectors,
  RewriteSelectorRules: RewriteSelectorRules,
