...
function RewriteSelectorRuleDialog(props) {
  ...
  useEffect(() => {
     ...
     * After Dialog Open
     */
    if (selectorRuleDialog.props.open && selectorRuleDialog.selectorType === 'rewrite' && !selectorRuleDialog.isSelector) {
      // initDialog();
      setOpen(true);
    } else {
      setOpen(false);
  ...
  function closeSelectorRuleDialog() {
    return selectorRuleDialog.type === 'edit'
      ? dispatch(closeEditSelectorRuleDialog({ selectorType: 'rewrite' }))
      : dispatch(closeNewSelectorRuleDialog({ selectorType: 'rewrite' }));
  }
...
export default RewriteSelectorRuleDialog;
