...
function RateLimiterSelectorDialog(props) {
  ...
  useEffect(() => {
     ...
     * After Dialog Open
     */
    if (selectorDialog.props.open && selectorDialog.selectorType === 'rateLimiter' && selectorDialog.isSelector) {
      // initDialog();
      setOpen(true);
    } else {
      setOpen(false);
  ...
  function closeSelectorDialog() {
    return selectorDialog.type === 'edit'
      ? dispatch(closeEditSelectorDialog({ selectorType: 'rateLimiter' }))
      : dispatch(closeNewSelectorDialog({ selectorType: 'rateLimiter' }));
  }
...
export default RateLimiterSelectorDialog;
