...
function RateLimiterSelectorRuleDialog(props) {
  ...
  useEffect(() => {
     ...
     * After Dialog Open
     */
    if (selectorRuleDialog.props.open && selectorRuleDialog.selectorType === 'rateLimiter' && !selectorRuleDialog.isSelector) {
      // initDialog();
      setOpen(true);
    } else {
      setOpen(false);
  ...
  function closeSelectorRuleDialog() {
    return selectorRuleDialog.type === 'edit'
      ? dispatch(closeEditSelectorRuleDialog({ selectorType: 'rateLimiter' }))
      : dispatch(closeNewSelectorRuleDialog({ selectorType: 'rateLimiter' }));
  }
...
export default RateLimiterSelectorRuleDialog;
