...
function SpringCloudSelectorDialog(props) {
  ...
  useEffect(() => {
     ...
     * After Dialog Open
     */
    if (selectorDialog.props.open && selectorDialog.selectorType === 'springCloud' && selectorDialog.isSelector) {
      // initDialog();
      setOpen(true);
    } else {
      setOpen(false);
  ...
  function closeSelectorDialog() {
    return selectorDialog.type === 'edit'
      ? dispatch(closeEditSelectorDialog({ selectorType: 'springCloud' }))
      : dispatch(closeNewSelectorDialog({ selectorType: 'springCloud' }));
  }
...
export default SpringCloudSelectorDialog;
