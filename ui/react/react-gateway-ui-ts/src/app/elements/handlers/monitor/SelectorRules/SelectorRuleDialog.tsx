...
function MonitorSelectorRuleDialog(props) {
  ...
  useEffect(() => {
     ...
     * After Dialog Open
     */
    if (selectorRuleDialog.props.open && selectorRuleDialog.selectorType === 'monitor' && !selectorRuleDialog.isSelector) {
      // initDialog();
      setOpen(true);
    } else {
      setOpen(false);
  ...
  function closeSelectorRuleDialog() {
    return selectorRuleDialog.type === 'edit'
      ? dispatch(closeEditSelectorRuleDialog({ selectorType: 'monitor' }))
      : dispatch(closeNewSelectorRuleDialog({ selectorType: 'monitor' }));
  }
...
export default MonitorSelectorRuleDialog;
