...
function FirewallSelectorRuleDialog(props) {
  ...
  useEffect(() => {
     ...
     * After Dialog Open
     */
    if (selectorRuleDialog.props.open && selectorRuleDialog.selectorType === 'firewall' && !selectorRuleDialog.isSelector) {
      // initDialog();
      setOpen(true);
    } else {
      setOpen(false);
  ...
  function closeSelectorRuleDialog() {
    return selectorRuleDialog.type === 'edit'
      ? dispatch(closeEditSelectorRuleDialog({ selectorType: 'firewall' }))
      : dispatch(closeNewSelectorRuleDialog({ selectorType: 'firewall' }));
  }
...
export default FirewallSelectorRuleDialog;
