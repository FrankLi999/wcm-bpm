...
function AppAuth(props) {
  ...
  const handleNewDialog = () => {
    dispatch(openNewSystemDialog({ dialogType: 'appAuth', data: {} }));
  };

  const handleEditDialog = (row, rowIndex) => {
    dispatch(openEditSystemDialog({ dialogType: 'appAuth', rowIndex: rowIndex, data: { title: rowIndex, notes: rowIndex } }));
  };
