...
public class ShipGoodsCommandPayload {
	...
	public String toString() {
		return "ShipGoodsCommandPayload [refId=" + refId + ", pickId=" + pickId + ", logisticsProvider="
				+ logisticsProvider + ", recipientName=" + recipientName + ", recipientAddress=" + recipientAddress
				+ "]";
	}
}
