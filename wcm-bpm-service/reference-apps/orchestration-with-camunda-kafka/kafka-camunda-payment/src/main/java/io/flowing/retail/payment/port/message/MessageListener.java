...
public class MessageListener {
	...
	public void retrievePaymentCommandReceived(String messageJson)
		...
		Message<RetrievePaymentCommandPayload> message = new ObjectMapper().readValue(messageJson,
				new TypeReference<Message<RetrievePaymentCommandPayload>>() {
				});
		RetrievePaymentCommandPayload retrievePaymentCommand = message.getPayload();

		System.out.println("Retrieve payment: " + retrievePaymentCommand.getAmount() + " for "
