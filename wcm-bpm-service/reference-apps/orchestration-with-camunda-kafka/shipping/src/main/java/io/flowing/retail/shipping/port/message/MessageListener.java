...
public class MessageListener {
	...
	// @StreamListener(target = Sink.INPUT, condition = "payload.messageType.toString()=='ShipGoodsCommand'")
	@StreamListener(target = Sink.INPUT, condition = "headers['type'].toString()=='ShipGoodsCommand'")
	@Transactional
