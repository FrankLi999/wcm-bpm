...
public class MessageListener {
	...
	@StreamListener(target = Sink.INPUT, condition = "headers['type'].toString()=='OrderPlacedEvent'")
	@Transactional
	 ...
	 */
	// @StreamListener(target = Sink.INPUT, condition = "payload.messageType.toString().endsWith('Event')")
	@StreamListener(target = Sink.INPUT, condition = "headers['type'].toString().endsWith('Event')")
	@Transactional
