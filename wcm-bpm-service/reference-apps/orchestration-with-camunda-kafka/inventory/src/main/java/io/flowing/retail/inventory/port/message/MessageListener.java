...
public class MessageListener {
	...
	// @StreamListener(target = Sink.INPUT, condition = "payload.messageType.toString()=='FetchGoodsCommand'")
	@StreamListener(target = Sink.INPUT, condition = "headers['type'].toString()=='FetchGoodsCommand'")
	@Transactional
