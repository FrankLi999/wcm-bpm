...
public class CaseExecutionQueryDto extends AbstractQueryDto<CaseExecutionQuery> {
	...
	public CaseExecutionQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	protected void applySortBy(CaseExecutionQuery query, String sortBy, Map<String, Object> parameters,
