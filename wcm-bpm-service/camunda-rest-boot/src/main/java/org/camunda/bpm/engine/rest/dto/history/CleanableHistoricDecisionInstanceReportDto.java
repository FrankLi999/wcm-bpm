...
public class CleanableHistoricDecisionInstanceReportDto
	...
	public CleanableHistoricDecisionInstanceReportDto(ObjectMapper objectMapper,
	...
	@Override
	protected void applySortBy(CleanableHistoricDecisionInstanceReport query, String sortBy,
			Map<String, Object> parameters, ProcessEngine engine) {
