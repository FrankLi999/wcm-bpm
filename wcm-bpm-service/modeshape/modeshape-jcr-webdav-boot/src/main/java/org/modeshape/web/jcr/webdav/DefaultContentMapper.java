...
import com.bpwizard.wcm.repo.webdav.WebdavConfiguration;
...
//    public static final String INIT_NEW_CONTENT_PRIMARY_TYPE_NAME = "org.modeshape.web.jcr.webdav.NEW_CONTENT_PRIMARY_TYPE_NAME";
    ...
    public void initialize( ServletContext servletContext ) {
    	WebdavConfiguration webdavConfiguration = ApplicationContextProvider.getApplicationContext().getBean("webdavConfiguration", WebdavConfiguration.class);
...
//        String newContentPrimaryType = getParam(servletContext, INIT_NEW_CONTENT_PRIMARY_TYPE_NAME);
        ...
        String contentPrimaryTypes = webdavConfiguration.getContentPrimaryTypeNames();
        String resourcePrimaryTypes = webdavConfiguration.getResourcePrimaryTypeNames();
        String newFolderPrimaryType = webdavConfiguration.getNewFolderPrimaryTypeNames();
        String newResourcePrimaryType = webdavConfiguration.getNewResourcePrimaryTypeNames();
        String newContentPrimaryType = webdavConfiguration.getNewContentPrimaryTypeNames();
