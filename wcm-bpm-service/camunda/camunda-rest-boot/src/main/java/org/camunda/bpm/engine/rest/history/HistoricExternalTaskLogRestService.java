...
//	HistoricExternalTaskLogResource getHistoricExternalTaskLog(@PathParam("id") String historicExternalTaskLogId);
	...
	List<HistoricExternalTaskLogDto> getHistoricExternalTaskLogs(
			HttpServletRequest request,
			Integer firstResult,
			Integer maxResults);

	List<HistoricExternalTaskLogDto> queryHistoricExternalTaskLogs(
			HistoricExternalTaskLogQueryDto queryDto,
			Integer firstResult, 
			Integer maxResults);

	CountResultDto getHistoricExternalTaskLogsCount(HttpServletRequest request);
