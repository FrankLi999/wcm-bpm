	...
	public void validate() {
		if (userId != null && groupId != null) {
			throw new InvalidRequestException(HttpStatus.BAD_REQUEST,
					"Identity Link requires userId or groupId, but not both.");
		}

		if (userId == null && groupId == null) {
			throw new InvalidRequestException(HttpStatus.BAD_REQUEST, "Identity Link requires userId or groupId.");
		}
	}
