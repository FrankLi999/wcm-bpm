...
public class JobDefinitionQueryDto extends AbstractQueryDto<JobDefinitionQuery> {
	...
	public JobDefinitionQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(JobDefinitionQuery query, String sortBy, Map<String, Object> parameters,
