...
public class DecisionRequirementsDefinitionQueryDto extends AbstractQueryDto<DecisionRequirementsDefinitionQuery> {
	...
	public DecisionRequirementsDefinitionQueryDto(ObjectMapper objectMapper,
	...
	protected void applyFilters(DecisionRequirementsDefinitionQuery query) {
		...
		if (decisionRequirementsDefinitionIdIn != null && !decisionRequirementsDefinitionIdIn.isEmpty()) {
			query.decisionRequirementsDefinitionIdIn(
					decisionRequirementsDefinitionIdIn.toArray(new String[decisionRequirementsDefinitionIdIn.size()]));
		}
		if (category != null) {
	...
	@Override
	protected void applySortBy(DecisionRequirementsDefinitionQuery query, String sortBy, Map<String, Object> parameters,
