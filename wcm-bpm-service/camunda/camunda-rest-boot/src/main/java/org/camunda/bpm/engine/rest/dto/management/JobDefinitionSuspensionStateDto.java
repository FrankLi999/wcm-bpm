...
public class JobDefinitionSuspensionStateDto extends SuspensionStateDto {
	...
	public void updateSuspensionState(ProcessEngine engine) {
		int params = (jobDefinitionId != null ? 1 : 0) + (processDefinitionId != null ? 1 : 0)
		...
		UpdateJobDefinitionSuspensionStateBuilder updateSuspensionStateBuilder = createUpdateSuspensionStateBuilder(
				engine);
	...
	protected UpdateJobDefinitionSuspensionStateBuilder createUpdateSuspensionStateBuilder(ProcessEngine engine) {
		UpdateJobDefinitionSuspensionStateSelectBuilder selectBuilder = engine.getManagementService()
		...
		if (jobDefinitionId != null) {
			...
			UpdateJobDefinitionSuspensionStateTenantBuilder tenantBuilder = selectBuilder
