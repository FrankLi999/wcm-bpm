...
/**
 * Base class for implementing a HAL resource as defined in <a href=
 * "http://tools.ietf.org/html/draft-kelly-json-hal-06#section-4">json-hal-06#section-4</a>
 *
 * @author Daniel Meyer
 *
 */
public abstract class HalResource<T extends HalResource<?>> {
	...
	/**
	 * Can be used to embed a relation. Embedded all linked resources in the given
	 * relation.
	 *
