...
public class ExternalTaskQueryDto extends AbstractQueryDto<ExternalTaskQuery> {
	...
	public ExternalTaskQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(ExternalTaskQuery query, String sortBy, Map<String, Object> parameters,
