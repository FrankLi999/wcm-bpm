...
public class ProcessInstanceQueryDto extends AbstractQueryDto<ProcessInstanceQuery> {
	...
	public ProcessInstanceQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	protected void applyFilters(ProcessInstanceQuery query) {
		...
		if (processDefinitionKeyNotIn != null && !processDefinitionKeyNotIn.isEmpty()) {
			query.processDefinitionKeyNotIn(
					processDefinitionKeyNotIn.toArray(new String[processDefinitionKeyNotIn.size()]));
		}
			...
			for (VariableQueryParameterDto variableQueryParam : variables) {
				...
				if (op.equals(VariableQueryParameterDto.EQUALS_OPERATOR_NAME)) {
					...
					throw new InvalidRequestException(HttpStatus.BAD_REQUEST,
							"Invalid variable comparator specified: " + op);
				}
			}
		}
	}
	...
	@Override
	protected void applySortBy(ProcessInstanceQuery query, String sortBy, Map<String, Object> parameters,
