...
public class IncidentQueryDto extends AbstractQueryDto<IncidentQuery> {
	...
	public IncidentQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(IncidentQuery query, String sortBy, Map<String, Object> parameters,
