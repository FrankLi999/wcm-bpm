...
public class AuthorizationDto {
	...
	public static void update(AuthorizationDto dto, Authorization dbAuthorization,
		...
		if (dto.getPermissions() != null) {
			dbAuthorization.setPermissions(PermissionConverter.getPermissionsForNames(dto.getPermissions(),
					dto.getResourceType(), engineConfiguration));
		}
	...
	private static Permission[] getPermissions(Authorization dbAuthorization,
		...
		Permission[] permissionsByResourceType = ((ProcessEngineConfigurationImpl) engineConfiguration)
				.getPermissionProvider().getPermissionsForResource(givenResourceType);
