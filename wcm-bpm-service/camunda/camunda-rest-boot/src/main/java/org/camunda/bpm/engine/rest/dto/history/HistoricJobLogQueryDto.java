...
public class HistoricJobLogQueryDto extends AbstractQueryDto<HistoricJobLogQuery> {
	...
	public HistoricJobLogQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(HistoricJobLogQuery query, String sortBy, Map<String, Object> parameters,
