...
//	HistoricJobLogResource getHistoricJobLog(@PathParam("id") String historicJobLogId);
	...
	List<HistoricJobLogDto> getHistoricJobLogs(HttpServletRequest request, Integer firstResult, Integer maxResults);

	List<HistoricJobLogDto> queryHistoricJobLogs(HistoricJobLogQueryDto queryDto,
			Integer firstResult, Integer maxResults);

	CountResultDto getHistoricJobLogsCount(HttpServletRequest request);
