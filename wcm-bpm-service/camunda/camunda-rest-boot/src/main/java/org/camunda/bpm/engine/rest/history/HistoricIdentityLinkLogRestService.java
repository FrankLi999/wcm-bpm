...
public interface HistoricIdentityLinkLogRestService {
	 ...
	 * @return
	 */
	List<HistoricIdentityLinkLogDto> getHistoricIdentityLinks(HttpServletRequest request,
			Integer firstResult, Integer maxResults);

	CountResultDto getHistoricIdentityLinksCount(HttpServletRequest request);
