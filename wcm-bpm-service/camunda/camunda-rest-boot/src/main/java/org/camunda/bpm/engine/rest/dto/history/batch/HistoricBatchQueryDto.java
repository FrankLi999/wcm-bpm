...
public class HistoricBatchQueryDto extends AbstractQueryDto<HistoricBatchQuery> {
	...
	public HistoricBatchQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	protected void applySortBy(HistoricBatchQuery query, String sortBy, Map<String, Object> parameters,
