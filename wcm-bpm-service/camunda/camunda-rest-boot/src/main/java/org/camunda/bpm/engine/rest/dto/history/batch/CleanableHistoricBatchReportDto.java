...
public class CleanableHistoricBatchReportDto extends AbstractQueryDto<CleanableHistoricBatchReport> {
	...
	public CleanableHistoricBatchReportDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(CleanableHistoricBatchReport query, String sortBy, Map<String, Object> parameters,
