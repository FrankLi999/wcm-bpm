...
public class CaseDefinitionQueryDto extends AbstractQueryDto<CaseDefinitionQuery> {
	...
	public CaseDefinitionQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	@Override
	protected void applySortBy(CaseDefinitionQuery query, String sortBy, Map<String, Object> parameters,
