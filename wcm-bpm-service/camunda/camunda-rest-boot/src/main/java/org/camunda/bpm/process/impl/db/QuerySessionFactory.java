 ...
 */
package org.camunda.bpm.process.impl.db;
...
public class QuerySessionFactory extends StandaloneProcessEngineConfiguration {
	...
	/**
	 * initialize the {@link ProcessEngineConfiguration} from an existing one, just
	 * using the database settings and initialize the database / MyBatis stuff.
	 */
