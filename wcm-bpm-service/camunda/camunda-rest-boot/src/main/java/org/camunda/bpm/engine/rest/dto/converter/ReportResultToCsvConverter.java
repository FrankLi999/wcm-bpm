...
public class ReportResultToCsvConverter {
	...
	public static String DURATION_HEADER = "PERIOD" + DELIMITER + "PERIOD_UNIT" + DELIMITER + "MINIMUM" + DELIMITER
			+ "MAXIMUM" + DELIMITER + "AVERAGE";
	...
	public static String convertReportResult(List<ReportResult> reports, String reportType) {
		...
		throw new InvalidRequestException(HttpStatus.BAD_REQUEST, "Unkown report type " + reportType);
	}
