...
public interface HistoricDecisionDefinitionRestService {
	...
	public List<CleanableHistoricDecisionInstanceReportResultDto> getCleanableHistoricDecisionInstanceReport(
			HttpServletRequest request, Integer firstResult, Integer maxResults);

	public CountResultDto getCleanableHistoricDecisionInstanceReportCount(HttpServletRequest request);
