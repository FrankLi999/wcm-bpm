...
public class BatchStatisticsQueryDto extends AbstractQueryDto<BatchStatisticsQuery> {
	...
	public BatchStatisticsQueryDto(ObjectMapper objectMapper, Map<String, String[]> queryParameters) {
	...
	protected void applySortBy(BatchStatisticsQuery query, String sortBy, Map<String, Object> parameters,
