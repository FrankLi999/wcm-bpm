...
public class MigratingProcessInstanceValidationReportDto {
	...
	public void setActivityInstanceValidationReports(
	...
	public void setTransitionInstanceValidationReports(
			List<MigratingTransitionInstanceValidationReportDto> transitionInstanceValidationReports) {
		this.transitionInstanceValidationReports = transitionInstanceValidationReports;
	}

	public static MigratingProcessInstanceValidationReportDto from(
		...
		dto.setActivityInstanceValidationReports(
				MigratingActivityInstanceValidationReportDto.from(validationReport.getActivityInstanceReports()));
		dto.setTransitionInstanceValidationReports(
