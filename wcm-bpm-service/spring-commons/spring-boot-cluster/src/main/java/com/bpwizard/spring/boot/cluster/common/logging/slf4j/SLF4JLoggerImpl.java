 ...
 */
package com.bpwizard.spring.boot.cluster.common.logging.slf4j;

import org.slf4j.LoggerFactory;

import com.bpwizard.spring.boot.cluster.common.i18n.I18nResource;
...
final class SLF4JLoggerImpl extends Logger {
     ...
     * calls {@link com.bpwizard.spring.boot.cluster.common.logging.Logger#error(com.bpwizard.spring.boot.cluster.common.i18n.I18nResource, Object...)}.
     *
     * @param t the exception (throwable) to log
     * @param message the message accompanying the exception
     * @param params the parameter values that are to replace the variables in the format string
     ...
     * calls {@link com.bpwizard.spring.boot.cluster.common.logging.Logger#info(com.bpwizard.spring.boot.cluster.common.i18n.I18nResource, Object...)}.
     *
     * @param t the exception (throwable) to log
     * @param message the message accompanying the exception
     * @param params the parameter values that are to replace the variables in the format string
