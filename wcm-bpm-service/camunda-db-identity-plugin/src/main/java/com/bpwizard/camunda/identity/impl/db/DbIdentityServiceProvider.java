...
/**
 * <p>
 * {@link WritableIdentityProvider} implementation backed by a database. This
 * implementation is used for the built-in user management.
 * </p>
 *
 * @author Daniel Meyer
 *
...
public class DbIdentityServiceProvider extends DbReadOnlyIdentityServiceProvider implements WritableIdentityProvider {
	...
	public DbIdentityServiceProvider() {
		System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>> Created com.bpwizard.camunda.identity.impl.db.DbIdentityServiceProvider");
	}
	// users ////////////////////////////////////////////////////////
