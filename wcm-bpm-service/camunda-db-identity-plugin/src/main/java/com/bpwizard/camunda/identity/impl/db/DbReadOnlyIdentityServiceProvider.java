...
public class DbReadOnlyIdentityServiceProvider extends AbstractManager implements ReadOnlyIdentityProvider {
	...
	public DbReadOnlyIdentityServiceProvider() {
		System.out.println(">>>>>>>>>>>>>>>>> Created com.bpwizard.camunda.identity.impl.db.DbReadOnlyIdentityServiceProvider");
	}
	// users /////////////////////////////////////////
	...
	public List<User> findUserByNativeQuery(Map<String, Object> parameterMap, int firstResult, int maxResults) {
		return getDbEntityManager().selectListWithRawParameter("selectUserByNativeQuery", parameterMap, firstResult,
				maxResults);
	}
