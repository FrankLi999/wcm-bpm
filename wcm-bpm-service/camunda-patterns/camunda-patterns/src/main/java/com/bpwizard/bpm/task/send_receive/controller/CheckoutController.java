package com.bpwizard.bpm.task.send_receive.controller;
...
import com.bpwizard.bpm.task.send_receive.domain.Customer;
import com.bpwizard.bpm.task.send_receive.domain.Order;
import com.bpwizard.bpm.task.send_receive.message.MessageSender;
import com.bpwizard.bpm.task.send_receive.message.PlaceOrderMessage;
