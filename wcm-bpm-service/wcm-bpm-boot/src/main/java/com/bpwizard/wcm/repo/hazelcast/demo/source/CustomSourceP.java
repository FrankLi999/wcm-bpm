...
import com.bpwizard.wcm.repo.hazelcast.demo.dao.HazelcastUserDao;
...
public class CustomSourceP extends AbstractProcessor {
    ...
    private Traverser<HazelcastUser> traverser;

    @Autowired
    private transient HazelcastUserDao userDao;
    ...
    public static BatchSource<HazelcastUser> customSource() {
