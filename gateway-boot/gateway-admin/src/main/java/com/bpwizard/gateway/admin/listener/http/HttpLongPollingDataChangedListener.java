...
public class HttpLongPollingDataChangedListener extends AbstractDataChangedListener {
    ...
    public HttpLongPollingDataChangedListener(final HttpSyncProperties httpSyncProperties) {
        ...
        this.scheduler = new ScheduledThreadPoolExecutor(1,
        		GatewayThreadFactory.create("long-polling", true));
    ...
    private List<ConfigGroupEnum> compareChangedGroup(final HttpServletRequest request) {
        ...
        for (ConfigGroupEnum group : ConfigGroupEnum.values()) {
            ...
            if (params == null || params.length != 2) {
                throw new GatewayException("group param invalid:" + request.getParameter(group.name()));
            }
    ...
    private boolean checkCacheDelayAndUpdate(final ConfigDataCache serverCache, final String clientMd5, final long clientModifyTime) {
        ...
        // otherwise it may cause the request from gateway-web to update the cache concurrently, causing excessive db pressure
