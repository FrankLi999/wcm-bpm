...
package com.bpwizard.spring.boot.cluster.journal;
...
import com.bpwizard.spring.boot.cluster.change.Change;
...
public final class JournalRecord implements Serializable, Iterable<Change> {
     ...
     * @see com.bpwizard.spring.boot.cluster.change.ChangeSet#getProcessKey()
     */
     ...
     * @see com.bpwizard.spring.boot.cluster.change.ChangeSet#getRepositoryKey()
     */
     ...
     * @see com.bpwizard.spring.boot.cluster.change.ChangeSet#getUserId()
     */
     ...
     * @see com.bpwizard.spring.boot.cluster.change.ChangeSet#getWorkspaceName()
     */
     ...
     * @see com.bpwizard.spring.boot.cluster.change.ChangeSet#changedNodes()
     */
    //public Set<NodeKey> changedNodes() {
    public Set<Serializable> changedNodes() {
        return content.changedNodes();
    }

    /**
     * Returns the identifier of the local {@link com.bpwizard.spring.boot.cluster.journal.ChangeJournal} instance.
     * 
     * @return either a non-null {@link String} if journaling is enabled, or {@code null} if journaling isn't enabled.
     * @see com.bpwizard.spring.boot.cluster.change.ChangeSet#getJournalId()
     */
     ...
     *
     * @return {@link com.bpwizard.spring.boot.cluster.change.ChangeSet} instance; never null
     */
