...
import com.bpwizard.spring.boot.cluster.common.util.CheckArg;
import com.bpwizard.spring.boot.cluster.common.util.StringUtil;
import com.bpwizard.spring.boot.cluster.common.util.TimeBasedKeys;
import com.bpwizard.spring.boot.cluster.i18n.I18nMessages;
...
public class LocalJournal implements ChangeJournal {
    ...
    /**
     * The records are a map of {@link com.bpwizard.spring.boot.cluster.journal.JournalRecord} instances keyed by a time-based key.
     */
    ...
    public synchronized void shutdown() {
        ...
        try {
            ...
            LOGGER.error(e, I18nMessages.cannotStopJournal);
        } finally {
            this.stopped = true;
        }
    }
...
//        }
    ...
    @Override
    public Iterator<Serializable> changedNodesSince( final long timestamp ) {
    	return null;
