...
export class WcmRendererComponent implements OnInit, OnDestroy {
  ...
  //   // Add languages
  //   if (this.wcmSystem.langs && this.wcmSystem.langs.length > 0) {
  //     this._translateService.addLangs(this.wcmSystem.langs);

  //     // Set the default language
  //     this._translateService.setDefaultLang(this.wcmSystem.langs[0]);
      
  //     // Set the navigation translations
  //     if (this.wcmSystem.locales) {
  //       this._fuseTranslationLoaderService.loadTranslations(...this.wcmSystem.locales);
  //     }

  //     // Use a language
  //     this._translateService.use(this.wcmSystem.langs[0]);  
  //   }

  //   this.siteArea = this.wcmSystem.siteAreas[this.router.url.replace(/\//g, '~')];
