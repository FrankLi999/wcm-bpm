...
import { PerfectScrollbarGeometry, PerfectScrollbarPosition } from './perfect-scrollbar.model';
...
export class PerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
    ...
    get perfectScrollbarOptions(): any {
        // Return the options
     ...
     * @ param prefix
     */
    geometry(prefix: string = 'scroll'): PerfectScrollbarGeometry
    {
        return new PerfectScrollbarGeometry(
     ...
     * @ param absolute
     */
    position(absolute: boolean = false): PerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new PerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
