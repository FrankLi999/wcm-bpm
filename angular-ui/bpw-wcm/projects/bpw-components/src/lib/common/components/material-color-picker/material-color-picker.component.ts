...
import { wcmMatColors } from '../../mat-colors/wcm-mat-colors';
...
export class MaterialColorPickerComponent implements ControlValueAccessor
{
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, wcm-navy-700 etc.)
    ...
    updateSelectedColor(): void
    {
        ...
        this.selectedColor = {
            ...
            bg     : this.selectedPalette === '' ? '' : wcmMatColors.getColor(this.selectedPalette)[this.selectedHue],
            fg     : this.selectedPalette === '' ? '' : wcmMatColors.getColor(this.selectedPalette).contrast[this.selectedHue]
        };
