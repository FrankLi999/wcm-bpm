...
@Component({
  selector: 'resource-render',
  templateUrl: './resource-render.component.html',
  styleUrls: ['./resource-render.component.scss']
})
export class ResourceRenderComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit() {
    ...
    console.log('>>>>>>> contentItemPath', contentItemPath);
  ...
  elementRenderContent(contentItem: ContentItem): string {
    console.log('this.rendererTemplate', this.rendererTemplate);
