...
@Component({
    ...
    <form #userForm = "ngForm" [rxwebForm]="userForm">
      ...
      <div class="form-group">
        <label>Task Id</label>
          <input type="text" name="taskId" [(ngModel)]="user.taskId"  class="form-control" [endsWith]="endsWithConditionalexpression"/>
      </div>
      <div class="form-group">
        <label>Company</label>
          <input type="text" name="company" [(ngModel)]="user.company"  class="form-control" [endsWith]="endsWithMessage"/>
      </div>
