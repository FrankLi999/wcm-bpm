...
/**
 * A connection to a back-end API.  This connection is initiated by apiman when
 * an inbound API request has passed all of the inbound policies and needs to be
 * proxied to the back-end API.
 *
 * Consumers of an {@link IApiConnection} are simply responsible for writing all of the
