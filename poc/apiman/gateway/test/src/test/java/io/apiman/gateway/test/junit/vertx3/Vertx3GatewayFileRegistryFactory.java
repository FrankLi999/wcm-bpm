 ...
 */
public class Vertx3GatewayFileRegistryFactory implements IGatewayTestServerFactory {

    /**
     * Constructor.
     */
    public Vertx3GatewayFileRegistryFactory() {
    }

    @Override
    public IGatewayTestServer createGatewayTestServer() {
        return new Vertx3GatewayFileRegistryServer();
    }
