...
/**
 * Runs the test plan that reproduces https://issues.jboss.org/browse/APIMAN-1214
 *
 * @author eric.wittmann@redhat.com
 */
@RunWith(ManagerRestTester.class)
@ManagerRestTestPlan("test-plans/apiman-1214-testPlan.xml")
@ManagerRestTestGatewayLog(
        ...
        "PUT:/mock-gateway/clients\n" + 
        "GET:/mock-gateway/system/status\n" + 
        "DELETE:/mock-gateway/clients/clientA/ClientApp/1.0\n" + 
        "GET:/mock-gateway/system/status\n" + 
        "DELETE:/mock-gateway/clients/clientB/ClientApp/1.0\n" + 
        "")
public class Apiman1214Test {
}
