...
/**
 * Runs the test plan that reproduces https://github.com/apiman/apiman/pull/719
 *
 * @author eric.wittmann@redhat.com
 */
@RunWith(ManagerRestTester.class)
@ManagerRestTestPlan("test-plans/apiman-719-testPlan.xml")
public class Apiman719Test {
}
