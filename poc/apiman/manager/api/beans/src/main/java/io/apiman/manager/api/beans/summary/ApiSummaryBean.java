...
public class ApiSummaryBean implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ApiSummaryBean other = (ApiSummaryBean) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "ApiSummaryBean [organizationId=" + organizationId + ", organizationName="
