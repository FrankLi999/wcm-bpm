...
public class ClientSummaryBean implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ClientSummaryBean other = (ClientSummaryBean) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public String toString() {
        return "ClientSummaryBean [organizationId=" + organizationId + ", organizationName="
