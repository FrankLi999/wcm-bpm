...
/**
 * Responsible for migrating export data from one version to the next.
 * Typically a chain of these migrators is used so that the data can
 * be migrated from version X to version Y.
