// js-logger Type Definition
// Currently, js-logger does not have a d.ts file available for download,
// so we are borrowing this one, which was written for Hawtio.
